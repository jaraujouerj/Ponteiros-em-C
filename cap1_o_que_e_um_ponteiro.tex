...
A Figura \ref{enderecos} representa esquematicamente a memória para este arranjo de variáveis. Lembre-se que neste caso estamos trabalhando com um computador de 64 bits, assim os endereços têm 8 bytes. 
